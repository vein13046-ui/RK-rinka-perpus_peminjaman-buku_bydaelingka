...
@section('content')
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-8" id="login-content" style="opacity: 0; pointer-events: none; transition: opacity 1s ease-out;">
