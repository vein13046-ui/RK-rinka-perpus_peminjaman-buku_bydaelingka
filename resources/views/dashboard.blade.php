        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 transition hover:shadow-md">
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 transition hover:shadow-md">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-slate-800">1,120</h3>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 transition hover:shadow-md">
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 transition hover:shadow-md">
                        ...
                        <div>
                            <p class="text-sm font-medium text-slate-500">Kembali</p>
