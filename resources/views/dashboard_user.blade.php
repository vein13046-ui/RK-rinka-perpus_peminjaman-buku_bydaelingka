...
@section('page-description', 'Lihat ringkasan koleksi dan akses buku dengan tampilan yang lebih tenang.')
        ...
        <div class="rounded-[2rem] bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-800 p-8 sm:p-10 text-white shadow-2xl overflow-hidden relative">
            ...
            <div class="relative flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
                <div class="max-w-2xl">
                    ...
                    <h3 class="mt-3 text-3xl sm:text-4xl font-black leading-tight">Halo, {{ Auth::user()->name }}.</h3>
                ...
                <a href="{{ route('user.books') }}" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-5 py-3.5 font-semibold text-slate-900 shadow-lg shadow-black/10 transition hover:-translate-y-0.5">
